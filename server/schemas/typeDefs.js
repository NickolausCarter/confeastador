...
type Query {
  ...
  restaurants(restaurantName: String, alias: String, cuisine: String, zipcode: String): [Restaurant]
...
type Mutation {
  ...
  addRestaurant(restaurantName: String!, alias: String!, cuisine: String!, zipcode: String!): Restaurant
